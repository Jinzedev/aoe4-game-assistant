import { User, Users, Zap } from 'lucide-react-native';
...
export const LEADERBOARD_OPTIONS = [
  ...
  { key: 'qm_1v1', name: '快速1v1', icon: Zap, color: '#f59e0b' },
  { key: 'qm_2v2', name: '快速2v2', icon: Users, color: '#10b981' },
  { key: 'qm_3v3', name: '快速3v3', icon: Users, color: '#10b981' },
  { key: 'qm_4v4', name: '快速4v4', icon: Users, color: '#10b981' },
];
